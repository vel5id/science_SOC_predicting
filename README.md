...
- The soil dataset is **not shipped in this repository** (commercially sensitive). To run the modelling pipeline, obtain it from the archived dataset record **[10.5281/zenodo.19496443](https://doi.org/10.5281/zenodo.19496443)** and place `master_dataset.csv` under `data/features/`.
