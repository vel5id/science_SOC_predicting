...
ax.set_yticklabels(heat.index, color="black", fontsize=7.5)
...
fig.savefig(OUT_DIR / "delta_heatmap.tiff", dpi=300, bbox_inches="tight",
...
for i, (feat, disp, chem, rho) in enumerate(top_pairs_uniq[:n_panels]):
    ...
    ax.set_xlabel(disp, color="black", fontsize=8)
    ax.set_ylabel(CHEM_LABELS[chem], color="black", fontsize=8)
...
fig2.savefig(OUT_DIR / "delta_top_scatter.tiff", dpi=300, bbox_inches="tight",
             facecolor="white", pil_kwargs={"compression": "tiff_lzw"})
